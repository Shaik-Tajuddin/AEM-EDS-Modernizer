...
## 1. Purpose
Renders the Search block with responsive layout and Universal Editor authoring.
Derived from AEM Component: `wknd/components/search`.
...
- **Pick this block when:** The AEM component is `wknd/components/search`.
