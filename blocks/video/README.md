...
## 1. Purpose
Renders the Video block with responsive layout and Universal Editor authoring.
Derived from AEM Component: `wknd/components/video`.
...
- **Pick this block when:** The AEM component is `wknd/components/video`.
